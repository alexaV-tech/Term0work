...
name = "Alexa"
x= int(input("How many times would you like to print this message:"))
def get_user_input(num):
    if num==5 :
     print_five_message(name)
    if num==1:
     print_message(name)
